...
#define APP_STATE_KLINE_CAPACITY MARKET_DATA_KLINES_V1_LIMIT
    ...
    typedef enum
    {
        ...
        APP_STATE_SYMBOL_ERROR,    // last attempt failed with an unrecoverable error - not retried until the watchlist
                                   // changes
...
#define APP_STATE_OTA_VERSION_MAX_LEN 32
    ...
    esp_err_t app_state_apply_kline_update(uint8_t index, const market_data_kline_update_t *update,
                                           int64_t interval_ms);
