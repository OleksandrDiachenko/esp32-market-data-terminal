...
extern "C"
{
    ...
    market_data_err_t market_data_http_open(const char *url, uint32_t timeout_ms,
                                            market_data_http_session_t **out_session, int *out_status);
    ...
    market_data_err_t market_data_http_stream_body(market_data_http_session_t *session,
                                                   market_data_http_body_sink_t sink, void *sink_ctx);
